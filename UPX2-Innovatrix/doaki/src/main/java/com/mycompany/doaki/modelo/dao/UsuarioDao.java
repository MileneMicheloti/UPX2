...
public class UsuarioDao {
    ...
    private void preencherValoresNoPreparedStatement(PreparedStatement prepareStatement, Usuario usuario)
        ...
        //String senhaCrypt = passwordEncoder.encode(usuario.getSenha()); --> para criptografar a senha
        
        // substituir o get senha por senhaCrypt --> substituir o terceiro por ese
